...
export const orders = sqliteTable("orders", {
  ...
  outForDeliveryAt: text("out_for_delivery_at").notNull().default(""),
  firstOutForDeliveryAt: text("first_out_for_delivery_at").notNull().default(""),
  ndrReason: text("ndr_reason").notNull().default(""),
  ndrAttempts: integer("ndr_attempts").notNull().default(0),
  ndrRaisedAt: text("ndr_raised_at").notNull().default(""),
  ndrJson: text("ndr_json").notNull().default("{}"),
  ...
  index("idx_orders_shipped_at").on(table.shippedAt),
  index("idx_orders_out_for_delivery_at").on(table.outForDeliveryAt),
